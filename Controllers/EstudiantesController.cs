...
namespace Crud_Funcional.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,FechaNacimiento,Email")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,FechaNacimiento,Email")] Estudiante estudiante)
        {

...
namespace Crud_Funcional.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(UniversidadContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMateria,NombreMateria,Creditos")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMateria,NombreMateria,Creditos")] Materia materia)
        {
